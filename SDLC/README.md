...
Work flows through two phases in **one long-running session** on the PR: a lightweight,
human-driven **product/design** phase, then the adversarial **engineering** cycle
